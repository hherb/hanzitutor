...
dependencies {
    ...
    // The fingerprint prompt, with the keystore cipher as its `CryptoObject` —
    // the only way to authenticate one decryption of the Dropbox sign-in. See
    // `PlatformPlugin.kt`, `askForFingerprint`.
